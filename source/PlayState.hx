			...
			case 'hampter':
				{
						defaultCamZoom = 0.1;
						curStage = 'hampter';
						var bg:FlxSprite = new FlxSprite(-500, -100).loadGraphic(Paths.image('hampter/sky'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.6, 0.6);
						bg.active = false;
						add(bg);
						
						var hills:FlxSprite = new FlxSprite(-800, -90).loadGraphic(Paths.image('hampter/hills'));
						hills.antialiasing = true;
						hills.setGraphicSize(Std.int(hills.width * 0.7));
						hills.scrollFactor.set(0.8, 0.8);
						hills.active = false;
						add(hills);
						
						var grass:FlxSprite = new FlxSprite(-2000, 600).loadGraphic(Paths.image('hampter/grass'));
